...
DEFAULT_COLUMNS = {
    "megadepth1500": [
        ...
        "mean_extractor_time_ms",
        "med_extractor_core_time_ms",
        "mean_extractor_core_time_ms",
        "med_matcher_time_ms",
        "mean_matcher_time_ms",
        "med_total_time_ms",
        "mean_total_time_ms",
        "med_extractor_memory_mb",
        "mean_extractor_memory_mb",
        "med_matcher_memory_mb",
        "mean_matcher_memory_mb",
        "med_forward_allocated_memory_mb",
        "mean_forward_allocated_memory_mb",
        "med_forward_reserved_memory_mb",
        "mean_forward_reserved_memory_mb",
        "med_pair_resolution",
        "mean_pair_resolution",
        "med_epi_prec@1e-4",
        "mean_epi_prec@1e-4",
        "med_epi_prec@5e-4",
        "mean_epi_prec@5e-4",
        ...
        "mean_num_keypoints",
        "med_reproj_prec@1px",
        "mean_reproj_prec@1px",
        "med_reproj_prec@3px",
        "mean_reproj_prec@3px",
        "med_reproj_prec@5px",
        "mean_reproj_prec@5px",
        "med_covisible",
        "mean_covisible",
        "med_covisible_percent",
        "mean_covisible_percent",
        "med_gt_match_recall@3px",
        "mean_gt_match_recall@3px",
        "med_gt_match_precision@3px",
        "mean_gt_match_precision@3px",
        "rel_pose_error@5°",
        "rel_pose_error@10°",
        "rel_pose_error@20°",
        "rel_pose_error_mAA",
